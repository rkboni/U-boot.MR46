...
void get_phy_address(int offset)
{
	...
	for (offset = fdt_first_subnode(gd->fdt_blob, offset); offset > 0;
		...
		phy_address = fdtdec_get_uint(gd->fdt_blob, offset, "phy_address", 0);
		phy_type = fdtdec_get_uint(gd->fdt_blob, offset, "phy_type", 0);
	...
	for (i = 0; i < IPQ807X_EDMA_DEV; edma_cfg++, i++) {
		...
		for (phy_id =  0; phy_id < PHY_MAX; phy_id++) {
			...
			if (phy_id == aquantia_port) {
				phy_chip_id1 = ipq_mdio_read(AQU_PHY_ADDR, (1<<30) |(1<<16) | QCA_PHY_ID1, NULL);
				phy_chip_id2 = ipq_mdio_read(AQU_PHY_ADDR, (1<<30) |(1<<16) | QCA_PHY_ID2, NULL);
				phy_chip_id = (phy_chip_id1 << 16) | phy_chip_id2;
			}

			switch(phy_chip_id) {
				case AQUANTIA_PHY_111: 		printf ("PHY: AQR111\n"); break;
				case AQUANTIA_PHY_111C:		printf ("PHY: AQR111C\n"); break;
				case AQUANTIA_PHY_111C_B0: 	printf ("PHY: AQR111C B0\n"); break;
				case AQUANTIA_PHY_112: 		printf ("PHY: AQR112\n"); break;
				case AQUANTIA_PHY_112C: 	printf ("PHY: AQR112C\n"); break;
				case AQUANTIA_PHY_112C_B0: 	printf ("PHY: AQR112C B0\n"); break;
				case AQUANTIA_PHY_113C: 	printf ("PHY: AQR113C\n"); break;
				case AQUANTIA_PHY_113C_A1: 	printf ("PHY: AQR113C A1\n"); break;
				case AQUANTIA_PHY_113C_B0: 	printf ("PHY: AQR113C B0\n"); break;
				case AQUANTIA_PHY_114C: 	printf ("PHY: AQR114C\n"); break;
				case AQUANTIA_PHY_114C_A1: 	printf ("PHY: AQR114C A1\n"); break;
				case AQUANTIA_PHY_114C_B0: 	printf ("PHY: AQR114C B0\n"); break;
				case AQUANTIA_PHY_115C: 	printf ("PHY: AQR115C\n"); break;
				case AQUANTIA_PHY_115C_A1: 	printf ("PHY: AQR115C A1\n"); break;
				case AQUANTIA_PHY_115C_B0: 	printf ("PHY: AQR115C B0\n"); break;
				case AQUANTIA_PHY_115C_B1: 	printf ("PHY: AQR115C B1\n"); break;

				case QCA8081_PHY:		printf ("PHY: QCA 8081\n"); break;
				case QCA8081_1_1_PHY:		printf ("PHY: QCA 8081 v1.1\n"); break;
				case QCA8033_PHY:		printf ("PHY: QCA 8033\n"); break;
			...
			switch(phy_chip_id) {
				...
				case AQUANTIA_PHY_111C_B0:
				case AQUANTIA_PHY_112:
				case AQUANTIA_PHY_112C:
				case AQUANTIA_PHY_112C_B0:
				case AQUANTIA_PHY_113C:
				case AQUANTIA_PHY_113C_A1:
				case AQUANTIA_PHY_113C_B0:
				case AQUANTIA_PHY_114C:
				case AQUANTIA_PHY_114C_A1:
				case AQUANTIA_PHY_114C_B0:
				case AQUANTIA_PHY_115C:
				case AQUANTIA_PHY_115C_A1:
				case AQUANTIA_PHY_115C_B0:
				case AQUANTIA_PHY_115C_B1:
